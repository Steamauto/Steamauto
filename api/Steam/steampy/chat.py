import bs4
import re
from .models import Endpoints, SteamUrl
...
class SteamChat:
    ...
    def _login(self, ui_mode="web"):
        ...
        params = {"ui_mode": self._chat_params.get("ui_mode"), "access_token": self._chat_params.get("access_token")}
    ...
    def _logout(self):
        ...
        params = {"access_token": self._chat_params.get("access_token"), "umqid": self._chat_params.get("umqid")}
        self._chat_params = {}
        return self._api_call(endpoint, params)

    def send_message(self, steamid_64, text):
        endpoint = Endpoints.SEND_MESSAGE
        params = {"access_token": self._chat_params.get("access_token"), "steamid_dst": steamid_64, "text": text, "type": "saytext", "umqid": self._chat_params.get("umqid")}
        return self._api_call(endpoint, params)
